...
var ingot = [<ore:ingotIron>,<ore:ingotGold>,<ore:ingotCopper>,<ore:ingotTin>,<ore:ingotLead>,<ore:ingotSilver>,
				<ore:ingotAluminium>,<ore:ingotIridium>,<ore:ingotNickel>,<ore:ingotPlatinum>,
...
var secondary = [ChanceItemIngredient.create(<ore:dustChromium>*5, 60),ChanceItemIngredient.create(<ore:dustSilver>, 50),ChanceItemIngredient.create(<ore:dustZinc>, 25),ChanceItemIngredient.create(<ore:dustZirconium>*5,25),ChanceItemIngredient.create(<ore:dustNickel>,50),
				...
				ChanceItemIngredient.create(<ore:dustCalcium>,5),ChanceItemIngredient.create(<ore:dustCalcium>,5),ChanceItemIngredient.create(<ore:dustAluminium>,50),ChanceItemIngredient.create(<ore:dustTitanium>,50),ChanceItemIngredient.create(<ore:dustThorium>,50)] as IIngredient[];
//var tertiary = 				
		
for i,item in rad_ore{		
FissionIrradiator.addRecipe(norm_ore[i],item, 250000, 10.0 , 0.01, 1.0e-6);
Enricher.addRecipe(item,<ore:dustBorax>,reactive_ore[i]*1000,0.5,2.5);
}
...
furnace.addRecipe(ingot[i],item);
if ((loadedMods has "mekanism")){
smelter.addRecipe(item,ingot[i]);
}
if ((loadedMods has "immersiveengineering")){
mods.immersiveengineering.ArcFurnace.addRecipe(ingot[i],item, null, 40, 200);
}
if ((loadedMods has "thermalexpansion")){
RedstoneFurnace.addRecipe(ingot[i],item,1500);
InductionSmelter.addRecipe(ingot[i],item,<ore:sand>,1000,<thermalfoundation:material:864>,35);
}
for i,item in shard_ore{
ore_leacher.addRecipe(item*4,nitric*16,chlor*16,sulfur*16,dust[i]*5,secondary[i],null,0.5,2.5);
}